...
${OBJECTDIR}/src/qrcodegen.o: src/qrcodegen.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/src" 
	@${RM} ${OBJECTDIR}/src/qrcodegen.o.d 
	@${RM} ${OBJECTDIR}/src/qrcodegen.o 
	@${FIXDEPS} "${OBJECTDIR}/src/qrcodegen.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1  -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -O1 -funroll-loops -D_SUPPRESS_PLIB_WARNING -MMD -MF "${OBJECTDIR}/src/qrcodegen.o.d" -o ${OBJECTDIR}/src/qrcodegen.o src/qrcodegen.c    -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD) 
...
${OBJECTDIR}/src/qrcodegen.o: src/qrcodegen.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/src/qrcodegen.o.d 
	@${RM} ${OBJECTDIR}/src/qrcodegen.o 
	@${FIXDEPS} "${OBJECTDIR}/src/qrcodegen.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE)  -g -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -O1 -funroll-loops -D_SUPPRESS_PLIB_WARNING -MMD -MF "${OBJECTDIR}/src/qrcodegen.o.d" -o ${OBJECTDIR}/src/qrcodegen.o src/qrcodegen.c    -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD) 
